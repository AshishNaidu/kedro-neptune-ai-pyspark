...
# neptune_ai_pyspark documentation build
...
from neptune_ai_pyspark import __version__ as release

# -- Project information -----------------------------------------------------

project = "neptune_ai_pyspark"
author = "Kedro"
...
htmlhelp_basename = "neptune_ai_pysparkdoc"
...
latex_documents = [
    (
        master_doc,
        "neptune_ai_pyspark.tex",
        "neptune_ai_pyspark Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "neptune_ai_pyspark",
        "Project neptune_ai_pyspark codebase.",
        "Data-Science",
    )
]
